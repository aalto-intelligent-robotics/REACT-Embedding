...
class TripletSelector:
    ...
    Original Implementation: https://github.com/adambielski/siamese-triplet
    """
...
class FunctionNegativeTripletSelector(TripletSelector):
    ...
    def get_triplets(self, embeddings, labels):
        ...
        if len(triplets) == 0:
            # Hot fix here: https://github.com/adambielski/siamese-triplet/issues/61#issuecomment-832151418
